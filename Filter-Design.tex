...
\end{eqnarray}
The response of the filter in (\ref{firlpfinal}) is shown in Figure 5.
...
\end{eqnarray}
%
The frequency response of the FIR bandpass filter designed to meet the given specifications is plotted in Figure 6.
\begin{figure}[h!]
\label{fig6}
